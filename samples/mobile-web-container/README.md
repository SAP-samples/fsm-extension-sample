...
4. On the screen, create a new web container with the following data:
    ...
    3. **Object Types:** Select any object type that supports web containers (for example, `Equipment`. For more information, see  [Supported Object Types](https://help.sap.com/docs/SAP_FIELD_SERVICE_MANAGEMENT/fsm_mobile/web-containers.html))
...
If you find a bug or need support, please open an issue [clicking here](https://github.com/SAP-samples/fsm-extension-sample/issues/new).
