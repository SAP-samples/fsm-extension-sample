# Outside Shell in a new tab extension sample

This extension is a minimalist sample of a front-end extension, which runs outside Shell in a new tab as a full custom app. The extension should be assigned to the Shell Home Screen and should not be assigned to an outlet.
